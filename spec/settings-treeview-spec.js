...
describe('AMU tree-view options', () => {
    ...
    it('should be able to toggle compact tree view items', () => {
        atom.config.set('papyrus-ui.treeView.compactList', false);
        expect(this.workspace.classList.contains('compact-tree-view')).toBe(false);

        atom.config.set('papyrus-ui.treeView.compactList', true);
    ...
    //     atom.config.set('papyrus-ui.treeView.blendTabs', false);
    //     expect(document.querySelector('.tabBlender')).toBe(null);
    //
    //     atom.config.set('papyrus-ui.treeView.blendTabs', true);
